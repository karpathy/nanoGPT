...
# ]
table = [
    ['r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r'],#<newline>
    ['r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r'],#<space>
    ['L', 'H', 'y', 'y', 'n', 'n', 'n', 'H', 'y', 'n', 'n', 'f'],#5 aka "sh"
    ['r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r'],#_ aka small tsu
    ['L', 'L', 'y', 'n', 'n', 'y', 'L', 'n', 'n', 'n', 'n', 'r'],#a
    ['M', 'L', 'n', 'n', 'y', 'y', 'M', 'n', 'n', 'n', 'n', 's'],#b
    ['H', 'L', 'y', 'n', 'n', 'n', 'M', 'n', 'n', 'y', 'n', 'r'],#c
    ['H', 'L', 'y', 'n', 'n', 'y', 'M', 'y', 'n', 'n', 'n', 's'],#d
    ['M', 'M', 'y', 'n', 'n', 'y', 'L', 'n', 'y', 'n', 'n', 'r'],#e
    ['M', 'L', 'y', 'n', 'n', 'n', 'H', 'n', 'n', 'n', 'n', 'r'],#f
    ['L', 'H', 'y', 'n', 'n', 'y', 'M', 'y', 'n', 'n', 'n', 's'],#g
    ['M', 'L', 'y', 'n', 'n', 'n', 'H', 'n', 'n', 'n', 'n', 'r'],#h
    ['H', 'L', 'y', 'n', 'n', 'y', 'L', 'n', 'y', 'n', 'n', 'r'],#i
    ['L', 'L', 'y', 'n', 'n', 'y', 'L', 'n', 'n', 'n', 'n', 'a'],#j
    ['L', 'H', 'y', 'n', 'n', 'n', 'H', 'y', 'n', 'n', 'n', 's'],#k
    ['L', 'L', 'n', 'n', 'n', 'y', 'L', 'n', 'n', 'n', 'n', 'r'],#m
    ['H', 'L', 'y', 'n', 'n', 'y', 'L', 'n', 'n', 'y', 'n', 'r'],#n
    ['L', 'M', 'y', 'y', 'n', 'y', 'L', 'y', 'n', 'n', 'n', 'r'],#o
    ['M', 'L', 'n', 'n', 'y', 'y', 'H', 'n', 'n', 'n', 'n', 's'],#p
    ['H', 'L', 'y', 'n', 'n', 'y', 'M', 'n', 'n', 'y', 'n', 'r'],#r
    ['H', 'L', 'y', 'n', 'n', 'n', 'M', 'n', 'n', 'y', 'n', 'r'],#s
    ['H', 'L', 'y', 'n', 'n', 'n', 'H', 'n', 'n', 'y', 'n', 's'],#t
    ['L', 'H', 'y', 'y', 'n', 'y', 'L', 'y', 'n', 'n', 'n', 'r'],#u
    ['M', 'H', 'y', 'y', 'n', 'y', 'L', 'n', 'n', 'n', 'n', 'r'],#w
    ['H', 'L', 'y', 'n', 'n', 'n', 'H', 'n', 'y', 'n', 'n', 'a'],#x
    ['M', 'H', 'y', 'n', 'n', 'y', 'L', 'n', 'n', 'n', 'n', 'r'],#y
    ['H', 'L', 'y', 'n', 'n', 'y', 'L', 'n', 'n', 'n', 'n', 'a'],#z
]
# table = [
