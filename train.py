...
from configurator import arguments
from dataclasses import dataclass

@arguments
@dataclass
class Args:
    out_dir: str = 'out' # output directory
    eval_interval: int = 2000 # number of iterations between evaluations
    log_interval: int = 1 # number of iterations between logging
    eval_iters: int = 200 # number of iterations to run evaluation for
    ...
    wandb_log: bool = False # whether to log to wandb
    wandb_project: str = 'owt' # wandb project name
    wandb_run_name: str = 'gpt2' # wandb run name
    ...
    beta_1: float = 0.9 # beta_1
    beta_2: float = 0.95 # beta_2
    ...
    config_file: str = None # config file to override default


globals().update(vars(Args())) # sic
