...
out_dir = experiment_name = wandb_run_name = 'normalized_gpt_test_remove_weight_normalizations'
wandb_log = True
wandb_notes = """Remove weight normalizations keep activation normalizations"""
