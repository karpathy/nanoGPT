...
out_dir = experiment_name = wandb_run_name = 'normalized_gpt_test_normalization_of_weights_dynamic_scalings_no_wd_noln'
wandb_log = True
wandb_notes = """Normalize MLP, Att, Embeddings add logit, qk, uv scaling no weight decay remove layer norms"""
