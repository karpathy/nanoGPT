# Config for SVD-LOZO training on Shakespeare dataset
# This tests our new SVD-guided low-rank optimization

# Output directory
out_dir = 'out-svdlozo-shakespeare'
...
svd_tau = 0.9  # threshold for adaptive rank selection (keep σ > τ * σ_max) - increased for actual rank reduction
