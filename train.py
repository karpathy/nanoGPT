...
def parse_args():
    ...
    # NORM VARIATIONS
    model_group.add_argument("--norm_variant_attn", type=str, default="rmsnorm", choices=["krmsnorm", "prmsnorm", "rmsnorm", "layernorm", "krmsnorm_recompute"])
    model_group.add_argument("--norm_variant_output", type=str, default="rmsnorm", choices=["krmsnorm", "prmsnorm", "rmsnorm", "layernorm", "krmsnorm_recompute"])
    ...
    model_group.add_argument("--krmsnorm_recompute_percentage", type=str, default=0.05, help="percentage needed within the total RMS to not trigger recompute")
