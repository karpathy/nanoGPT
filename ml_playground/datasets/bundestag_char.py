...
def main() -> None:
    """Prepare a character-level dataset from ml_playground/datasets/bundestag_char/page1.txt

    - Reads page1.txt from ml_playground/datasets/bundestag_char
