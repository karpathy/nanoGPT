# Config for DiLoZO with Rank Adaptive training on Shakespeare dataset

# Output directory
out_dir = 'logs/dilozo-rank-adaptive-shakespeare'
...
wandy_run_name = 'dilozo-rank-adaptive-shakespeare'
...
rank_adaptive = True     # Enable adaptive linear rank scheduling
