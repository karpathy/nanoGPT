...
def parse_args():
    ...
    model_group.add_argument("--quantization_wte_method", type=str, default="affine_quant", choices=["symmetric_quant", "affine_quant", "stochastic_quant"], help="function used for word embedding quantization")
    model_group.add_argument("--quantization_wte_bits", type=int, default=8, help="number of bits for word embedding quantization")
    model_group.add_argument("--quantization_wpe_method", type=str, default="affine_quant", choices=["symmetric_quant", "affine_quant", "stochastic_quant"], help="function used for position embedding quantization")
    ...
    model_group.add_argument("--activations_quant_method", type=str, default="affine_quant", choices=["affine_quant", "stochastic_quant"], help="function used for quantization of activations")
    model_group.add_argument("--quantize_attn", action=argparse.BooleanOptionalAction, default=False, help="quantize all input/output activations in attn")
    model_group.add_argument("--quantize_attn_bits", type=int, default=8, help="number of bits for attn quantization")
    model_group.add_argument("--quantize_attn_input", action=argparse.BooleanOptionalAction, default=False, help="quantize input activation to attn")
    model_group.add_argument("--quantize_attn_input_bits", type=int, default=None, help="number of bits for attn input quantization")
    model_group.add_argument("--quantize_qk_mult_inputs", action=argparse.BooleanOptionalAction, default=False, help="quantize input activation to qk mult")
    model_group.add_argument("--quantize_qk_mult_inputs_bits", type=int, default=None, help="number of bits for qk mult input quantization")
    model_group.add_argument("--quantize_softmax_input", action=argparse.BooleanOptionalAction, default=False, help="quantize input activation to softmax")
    model_group.add_argument("--quantize_softmax_input_bits", type=int, default=None, help="number of bits for softmax input quantization")
    model_group.add_argument("--quantize_pv_mult_inputs", action=argparse.BooleanOptionalAction, default=False, help="quantize input activation to pv mult")
    model_group.add_argument("--quantize_pv_mult_inputs_bits", type=int, default=None, help="number of bits for pv mult input quantization")
    model_group.add_argument("--quantize_pv_mult_output", action=argparse.BooleanOptionalAction, default=False, help="quantize output activation of pv_mult")
    model_group.add_argument("--quantize_pv_mult_output_bits", type=int, default=None, help="number of bits for pv mult output quantization")
    model_group.add_argument("--quantize_mlp", action=argparse.BooleanOptionalAction, default=False, help="quantize all input/output activations in mlp")
    model_group.add_argument("--quantize_mlp_bits", type=int, default=8, help="number of bits for mlp quantization")
    model_group.add_argument("--quantize_mlp_input", action=argparse.BooleanOptionalAction, default=False, help="quantize input activation to mlp")
    model_group.add_argument("--quantize_mlp_input_bits", type=int, default=None, help="number of bits for mlp input quantization")
    model_group.add_argument("--quantize_activation_input", action=argparse.BooleanOptionalAction, default=False, help="quantize input activation to activation function")
    model_group.add_argument("--quantize_activation_input_bits", type=int, default=None, help="number of bits for activation function input quantization")
    model_group.add_argument("--quantize_activation_output", action=argparse.BooleanOptionalAction, default=False, help="quantize output activation of activation function")
    model_group.add_argument("--quantize_activation_output_bits", type=int, default=None, help="number of bits for activation function output quantization")
    model_group.add_argument("--quantize_mlp_output", action=argparse.BooleanOptionalAction, default=False, help="quantize output activation of mlp")
    model_group.add_argument("--quantize_mlp_output_bits", type=int, default=None, help="number of bits for mlp output quantization")
